...
var MoviesAPI = /** @class */ (function (_super) {
    ...
    function MoviesAPI() {
        ...
        _this.apiKey = "bc96567e2f93790dea0e0c481845bc1b";
        _this.baseURL = "https://api.themoviedb.org/3/";
        return _this;
    }
    MoviesAPI.prototype.willSendRequest = function (request) {
        request.params.set("api_key", this.apiKey);
    };
    MoviesAPI.prototype.getMovie = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get("movies/" + id)];
            });
        });
    };
    return MoviesAPI;
